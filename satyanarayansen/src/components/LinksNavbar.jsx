...
const LinksNavbar = () => {
    return (
        <div className="sm:flex sm:flex-col md:flex md:flex-row lg:flex lg:flex-row items-center justify-between    px-10 py-3 bg-gray-800 text-white border-b-[0.5px] border-gray-300 fixed top-0 z-50 w-full">
