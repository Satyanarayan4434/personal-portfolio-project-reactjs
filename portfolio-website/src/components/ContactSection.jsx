function ContactPage() {
  return (
    <div className="lg:bg-[#B2C8BA] bg-[#164863] lg:pt-[5rem] pt-[2rem] pb-10">
      {/* wrapper */}
          ...
          <div className="bg-white opacity-50 rounded-lg p-10">
            <form action="post" className="flex flex-col items-start justify-center gap-8">
              <div className="flex flex-col ">
                ...
                <input type="text" id="name" className="outline-none p-3 border-none bg-slate-300 lg:w-[29rem] w-[15rem] h-10 rounded-xl"/>
              </div>
              <div className="flex flex-col ">
                <label htmlFor="email" className="text-[1.1rem]">
                  email:<span className="text-red-900">*</span>
                </label>
                <input type="email" id="email" className="outline-none p-3 border-none bg-slate-300 lg:w-[29rem] w-[15rem] h-10 rounded-xl"/>
              </div>
              <div className="flex flex-col ">
                <label htmlFor="message" className="text-[1.1rem]">
                  Message:<span className="text-red-900">*</span>
                </label>
                <textarea type="text" id="message" className="outline-none p-3 border-none bg-slate-300 lg:w-[29rem] w-[15rem] h-[10rem] rounded-xl"/>
              </div>
